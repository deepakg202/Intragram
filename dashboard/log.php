			...
			<div class="container">
				<div class="row">
					<div class="col-md-3">
						...
						<br/>
						<div class="profile-nav py-3" id="nav">
							<div class="d-flex flex-md-column flex-sm-row justify-content-around">
							 <a class="p-2" href="index.php"><span class="fa fa-user fa-fw"></span> Overview</a>
							 <a class="p-2 active-nav" href="log.php"><span class="fa fa-list-alt fa-fw"></span> Activity Log</a>
